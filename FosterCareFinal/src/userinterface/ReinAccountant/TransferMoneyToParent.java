 ...
 * @author jaspr
 */
public class TransferMoneyToParent extends javax.swing.JPanel {
    ...
    Child childval;
    Parent parentval;
    ReinTransferMoneyRequest workrequest;
    JPanel rightpanel1;
    
    public TransferMoneyToParent(EcoSystem business,
            UserAccount account,JPanel userProcessContainer,Enterprise enterprise,
            Organization organization,Child childval,Parent parentval,ReinTransferMoneyRequest workrequest,JPanel rightpanel1) {
        initComponents();
    ...
    private void btn_payActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_payActionPerformed
        ...
        if(txt_amount.getText().isEmpty() || txt_cvv.getText().isEmpty()) {
            ...
            workrequest.setMessage("Payment Recieved");
            workrequest.setStatus("Payment Recieved");
            workrequest.setAmount(workrequest.getAmount());
            workrequest.setChild(childval);
            workrequest.setParent(parentval);
