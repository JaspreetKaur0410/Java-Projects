...
public class DoctorSeeReportJPanel extends javax.swing.JPanel {
        ...
        if(childval.getLabtestlist() == null){
            ...
            for(ChildLabTests clt:childval.getLabtestlist()){
                if(clt.isIs_bloodTestRequired() && !clt.isIs_urineTestRequired()){
                    ...
                    for(ChildLabTests clt1:childval.getLabtestlist()){
                        if(String.valueOf(clt1.getDopamine()) != null){
                            isUrine = true;
                ...
                else if(clt.isIs_urineTestRequired() && !clt.isIs_bloodTestRequired())
                {
                    ...
                    tbl_urine.setVisible(true);
                    for(ChildLabTests clt1:childval.getLabtestlist()){
                        if(String.valueOf(clt1.getBloodcount()) != null){
                            isBlood = true;
                            panel_tbl_blood.setVisible(true);
                            tbl_blood.setVisible(true);
                        }
        ...
        for(ChildLabTests clt:childval.getLabtestlist()){
            if(childval.getLabtestlist()!=null){
                ...
                if(clt.isIs_urineTestRequired() && !clt.isIs_bloodTestRequired()){
                    //JOptionPane.showMessageDialog(rightpanel1, childval.getLabtestlist());
    ...
    private void initComponents() {
        ...
        panel_tbl_blood.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 820, 120));
        ...
        panel_tbl_urine.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 810, 110));
        ...
        panel_vitals.add(jLabel63, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 20, -1, -1));
        ...
        panel_vitals.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 820, 120));
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(panel_tbl_urine, javax.swing.GroupLayout.PREFERRED_SIZE, 822, javax.swing.GroupLayout.PREFERRED_SIZE)
