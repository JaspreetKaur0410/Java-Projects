...
import userinterface.CulturalEventOrganiser.CulturalEventWorkArea;
 ...
 * @author jaspr
 */
public class CulturalEventOrganiser extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Network network, 
        ...
        return new CulturalEventWorkArea(userProcessContainer, account, network,
                (Business.Organization.CulturalEventOrganiser)organization, enterprise, business,childdir,parentdir
        );
    }
    
    public String toString(){
        return (RoleType.CulturalEventOrganiser.getValue());
    }
