            ...
            txt_agency.setText(organization.getName());
                ...
                if(useraccountdir.checkIfUsernameIsUnique(username)){
                    child = childdir.addChild(++count,firstname,lastname,gender,age,city,race,religion,about,date_profile,
                                                            username,password,organization,check_specialChild);
                    business.getChildDirectory().addChild(age, firstname, lastname, gender, age, city, race, religion, about, date_profile, username, password, organization, check_specialChild);
