...
public class RegisterChildJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 242, -1));
        ...
        panel_singleparent.add(jLabel52, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, -1, -1));
        ...
        jPanel2.add(panel_singleparent, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 273, 530));
        ...
        jPanel5.add(txtUserName, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 340, 250, -1));
        ...
        jPanel5.add(pwdField, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 400, 250, -1));

        jLabel48.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel48.setText("CREATE ACCOUNT");
        jPanel5.add(jLabel48, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 290, -1, -1));
        ...
        jPanel5.add(btn_createaccout1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 470, 123, -1));
        ...
        jPanel5.add(txt_about, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 180, 200));
         ...
         if(txt_firstname.getText().isEmpty() || txt_lastname.getText().isEmpty()
            ...
            txt_agency.setText(organization.getName());
                ...
                if(useraccountdir.checkIfUsernameIsUnique(username)){
                    ...
                    business.getChildDirectory().addChild(age, firstname, lastname, gender, age, city, race, religion, about, date_profile, username, password, organization);
