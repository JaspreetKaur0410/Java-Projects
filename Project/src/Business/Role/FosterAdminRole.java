 ...
 * @author jaspr
 */
public class FosterAdminRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Network network, 
        ...
        return new FosterAdminWorkAreaJPanel(userProcessContainer, account, network,
                (FosterOrganization)organization, enterprise, business,childdir,parentdir
        );
    }
    
    public String toString(){
        return (RoleType.FosterAdmin.getValue());
    }
